...
@Component({
  ...
  template: `
    <div class="bg-[#eceae6]">
      ...
      >
        <form class="max-w-lg bg-white shadow-md rounded px-0 pt-6 pb-8 mb-4">
          ...
          <div class="px-8">
            <button
              class="bg-[#00005A] hover:bg-teal-700 text-white font-bold py-2 px-8 rounded w-full"
              type="submit"
            >
